...
public class CucumberNameResolver implements TestNameResolver {
    ...
    public static final String SCENARIO_COUNT_PARAMETER = "scenario_count";
    ...
    public static String generateTestName(PickleWrapper pickleWrapper, FeatureWrapper featureWrapper, int amountOfTests) {
